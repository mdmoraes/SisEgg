object FrmRelDespesas: TFrmRelDespesas
  ...
  object Query1: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'SELECT DESCRICAO, DATA_DESP, VALOR'
      'FROM DESPESAS'
    ...
    object Query1DESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'SYSUNI."DESPESAS.DB".Descricao'
      Size = 60
    end
    object Query1DATA_DESP: TDateField
      FieldName = 'DATA_DESP'
      Origin = 'SYSUNI."DESPESAS.DB".Data_Desp'
    end
    object Query1VALOR: TCurrencyField
      FieldName = 'VALOR'
      Origin = 'SYSUNI."DESPESAS.DB".Valor'
    end
  end
end
